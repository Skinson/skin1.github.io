...
<html lang="en">
	<?php 
		...
		if (!$language) include 'php/EN.php';
		else {
			if($language =="fr") include 'php/FR.php';
		}
		?>        
    ...
    THEME INFO
    =========================== -->
    <meta name="description" content="A way for me to showcase my work and projects">
    <meta name="keywords" content="MARCQ, Samson, developer, Java, C++, Android, OOP, ">
    ...
    SITE TITLE
    =========================== -->
    <title>MARCQ Samson</title><!-- This is what you see on your browser tab-->
   ...
   =========================== -->
       ...
       <header> 
        ...
        <div id="hero">           
            <div class="container herocontent">               
                ...
                <h4 class="wow fadeInDown" data-wow-duration="3s"><?php echo "$subtitle";?> </h4>            
            </div>
            
            <!-- Featured image on the Hero area -->
            <img class="heroshot wow bounceInUp" data-wow-duration="4s" src="img/exApps2.png" alt="Featured Work">            
        </div><!--HERO AREA END-->        
               ...
               <div class="container">
                      ...
                      <div class="navbar-header">
                       <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                           ...
                           <a class="navbar-brand" >
                            ...
                            <span class="brandname">MARCQ Samson</span>
							<script language="JavaScript" src="js/menu.js"></script>
							<script language="JavaScript" src="js/menu_tpl.js">	</script>
							
							<script language="JavaScript">
							var MENU_ITEMS = [
								['<span class="brandicon icon2-flag"></span>', null, null ,
								['<img  height="15" width="15";visibility: visible; src="img/fr.png"; alt="Fr">','index.php?lang=fr'],
								['<img  height="15" width="15";visibility: visible; src="img/uk.png"; alt="En">','index.php'],
								['<img  height="15" width="15";visibility: visible; src="img/de.png"; alt="De">','#'],
								['<img  height="15" width="15";visibility: visible; src="img/es.png"; alt="Es">','#'] 
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
                        ...
                        <li><a href="mailto:peaudechamois@hotmail.com"><span class="btnicon icon-envelope-open"></span>Contact</a></li>
                        <li class="active"><a href="cv.txt"><span class="btnicon icon-cloud-download"></span>Download CV</a></li>
                    </ul>
    ...
    =========================== -->
     <div id="clients">
         <div class="container">
             <div class="col-md-3">
                 <h4><?php echo "$workwith";?></h4>
             </div>
             <div class="col-md-9">
                 <ul><!--CLIENTS LOGO-->
                     <li><a href="http://limos.isima.fr/"><img src="img/limos.png" alt="LIMOS" height=68px></li>
                     <li><a href="http://www.adrien-nicod.fr"><img src="img/AdrienNicod.png" alt="Adrien Nicod"></a> </li>
    ...
    =========================== -->
     <div id="about" class="container">
        ...
        <!-- LEFT PART OF THE ABOUT SECTION -->
         <div class="col-md-6">
            <div class="row">
             <h2 class="wow fadeInDown" data-wow-duration="2s">I'm Samson MARCQ from France</h2>

             <h4 class="wow fadeInUp" data-wow-duration="3s">A freelance developper as well as a Crypto-currency enthusiast</h4>
             
             <p class="wow fadeInDown" data-wow-duration="3s">This website is where I will show what I'm working on and make contact with new customers.</p>
             <p class="wow fadeInDown" data-wow-duration="3s">My favourite languages are Java and C++, but I can pick up any Object Oriented language pretty quickly.</p>
             
             <a class="dribbble-follow-button wow bounce" href="http://dribbble.com/skinson">Follow</a>
             </div> <!-- ABOUT INFO END -->
             
            
            <div class="myapps row">
                <h5>Tools and apps I use almost everyday:</h5>
                
                <ul><!-- FAVORITE APP ICONS START -->
                    <li><img class="wow animated bounceInUp" data-wow-duration="1s" src="img/gimp.png" alt="Gimp"></li>
                    <li><img class="wow bounceInUp" data-wow-duration="2s" src="img/npp.png" alt="Notepad++"></li>
                    <li><img class="wow bounceInUp" data-wow-duration="3s" src="img/androidstudio.png" alt="Android Studio"></li>
                    <li><img class="wow animated bounceInUp" data-wow-duration="4s" src="img/eclipse.png" alt="Eclipse"></li>
                    <li><img class="wow bounceInUp" data-wow-duration="5s" src="img/genymotion.png" alt="Genymotion"></li>
        ...
        <!--Left part end-->
         ...
         <div class="col-md-6 wow fadeInUp myphoto" data-wow-duration="4s">
             <img src="img/skinson2.png" alt="MARCQ Samson">
    ...
    <div id="services" class="container">
        ...
        <div class="sectionhead  row wow fadeInUp">
			<span class="bigicon icon2-superman"></span>
        ...
        <div class="row">
               <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <img src="img/photo134.svg" alt="" height="100">
                   <h4>Image Processing</h4>
                   <p>Need to streamline a process on pictures or videos? I can create software that'll do it automatically. </p>
                </div> <!-- ITEM END -->

                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <img src="img/apple.svg" alt="" height ="100">
                   <h4>Android App Development</h4>
                   <p>Need an App for your specific needs? Wether it's to check a security camera or update your blog, I'm up for it!</p>
                </div> <!-- ITEM END -->
               ...
               <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   ...
                   <p>Need more manpower for the creation of an application? As a freelance I can help.</p>
                </div> <!-- ITEM END -->
    ...
    <div id="portfolio">
        <div class="sectionhead wow bounceInUp" data-wow-duration="2s">
			<span class="bigicon icon2-blueprint"></span>
    ...
    <div id="testimonials" class="container">
        <div class="sectionhead wow bounceInUp" data-wow-duration="2s">
           <span class="bigicon icon-bubble"></span>
  ...
  <div class="footercredit">Icons made by Freepik from <a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a>         is licensed by <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0">CC BY 3.0</a></div>
</html>